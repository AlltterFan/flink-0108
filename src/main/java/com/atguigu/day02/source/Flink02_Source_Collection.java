...
public class Flink02_Source_Collection {
    public static void main(String[] args) throws Exception {
        ...
        //TODO 从java集合中获取数据
        DataStreamSource<Integer> collectionDStream = env.fromCollection(Arrays.asList(1, 2, 3, 4, 5));
        ...
        //TODO 获取元素数据
        DataStreamSource<String> elemDStream = env.fromElements("1", "2", "3");
        ...
        DataStreamSource kafkaDStream = env.addSource(new FlinkKafkaConsumer<>("flink-0108", new SimpleStringSchema(), properties));

        collectionDStream.print("collection");
        textFileDStream.print("textFile");
        socketTextDStream.print("socket");
        elemDStream.print("elem");
